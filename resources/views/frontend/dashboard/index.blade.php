    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">Pelatihan Terdaftar</p>
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <a href="https://bolearn.id/" target="_blank">
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">LMS Bapelkes</p>
    ...
    <div class="col-lg-4 responsive-column-half">
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                ...
                <a href="https://lms.kemkes.go.id/" target="_blank">
                    <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                ...
                <div class="pl-4">
                    <p class="card-text fs-18">LMS Kemenkes</p>
